...
namespace Script3rLibrary
{
    public class text_to_take
    {
        ...
        public static List<string> SearchStr(string audio)
        {
            ...
            takeNum = ParseEnglish(takeNum).ToString();
            ...
            sceneNum = ParseEnglish(sceneNum).ToString();
            fileData.Add(sceneNum + sceneLetter);
            fileData.Add(takeNum);
